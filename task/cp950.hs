         ...
         | otherwise = do
           ...
           where
             ...
             chr2 c0 c1 = 
                  ...
                  in 
                      case find ((c0c1==) . fst) mapCP950Unicode of
                        Just (cp950,unicode) -> Just (unsafeChr unicode)
                        Nothing -> Nothing 
      ...
      loop !ir !ow
        ...
        | otherwise = do
           ...
           if os - ow < 2 then done ir ow else do
                let n = ord c
                case find ((n ==) . snd) mapCP950Unicode of
                    Just x -> do
                        let (c1,c2) = ord2 (fst x)
...
toCP950 :: Int -> Int
toCP950 unicode = 
    case (find ((unicode ==) . snd) mapCP950Unicode) of
        Just x -> fst x
        Nothing -> 0xB169
